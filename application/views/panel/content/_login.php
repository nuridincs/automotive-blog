...
<html class="no-js" lang="en">
    <head>
        ...
        <!-- Place favicon.ico in the root directoryf -->
            ...
            <div class="auth-container">
                <div class="card">
                    ...
                    <div class="auth-content">
                        ...
                        <!-- <form id="login-form" action="<?php //echo base_url('administrator/process/login'); ?>" method="POST" novalidate=""> -->
                                                
                        <?php echo validation_errors(); ?>

                        <?php echo form_open('administrator/process/login'); ?>    
