...
<!-- Bootstrap core CSS -->
<link href="<?= base_url('assets/'); ?>automotive/css/bootstrap.min.css" rel="stylesheet">

<!-- HTML5 shiv and Respond.js IE8 support of HTML5 elements and media queries -->
<!--[if lt IE 9]>
      <script src="<?= base_url('assets/'); ?>automotive/js/html5shiv.js"></script>
      <script src="<?= base_url('assets/'); ?>automotive/js/respond.min.js"></script>
    <![endif]-->

<link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Yellowtail%7COpen%20Sans%3A400%2C300%2C600%2C700%2C800" media="screen" />
<!-- Custom styles for this template -->
<link href="<?= base_url('assets/'); ?>automotive/css/font-awesome.min.css" rel="stylesheet" type="text/css" media="all">
<link rel="stylesheet" href="<?= base_url('assets/'); ?>automotive/css/flexslider.css" type="text/css" media="screen" />
<link rel="stylesheet" href="<?= base_url('assets/'); ?>automotive/css/jquery.bxslider.css" type="text/css" media="screen" />
<link href="<?= base_url('assets/'); ?>automotive/css/jquery.fancybox.css" rel="stylesheet">
<link href="<?= base_url('assets/'); ?>automotive/css/jquery.selectbox.css" rel="stylesheet">
<link href="<?= base_url('assets/'); ?>automotive/css/style.css" rel="stylesheet">
<link href="<?= base_url('assets/'); ?>automotive/css/mobile.css" rel="stylesheet">
<link rel="stylesheet" type="text/css" href="<?= base_url('assets/'); ?>automotive/css/settings.css" media="screen" />
<link href="<?= base_url('assets/'); ?>automotive/css/animate.min.css" rel="stylesheet">
<link href="<?= base_url('assets/'); ?>automotive/css/ts.css" type="text/css" rel="stylesheet">
<script type="text/javascript" src="<?= base_url('assets/'); ?>automotive/js/jquery.min.js"></script>
<script src="<?= base_url('assets/'); ?>automotive/js/bootstrap.min.js"></script>
<script type="text/javascript" src="<?= base_url('assets/'); ?>automotive/js/wow.min.js"></script>
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key="></script>

<script type="text/javascript" src="<?= base_url('assets/'); ?>automotive/js/jquery.themepunch.tools.min.js"></script>
<script type="text/javascript" src="<?= base_url('assets/'); ?>automotive/js/jquery.themepunch.revolution.min.js"></script>

<!-- SLIDER REVOLUTION 5.0  
            (Load Extensions only on Local File Systems !  
            The following part can be removed on Server for On Demand Loading) -->  
<script type="text/javascript" src="<?= base_url('assets/'); ?>automotive/js/revolution.extension.actions.min.js"></script>
<script type="text/javascript" src="<?= base_url('assets/'); ?>automotive/js/revolution.extension.carousel.min.js"></script>
<script type="text/javascript" src="<?= base_url('assets/'); ?>automotive/js/revolution.extension.kenburn.min.js"></script>
<script type="text/javascript" src="<?= base_url('assets/'); ?>automotive/js/revolution.extension.layeranimation.min.js"></script>
<script type="text/javascript" src="<?= base_url('assets/'); ?>automotive/js/revolution.extension.migration.min.js"></script>
<script type="text/javascript" src="<?= base_url('assets/'); ?>automotive/js/revolution.extension.navigation.min.js"></script>
<script type="text/javascript" src="<?= base_url('assets/'); ?>automotive/js/revolution.extension.parallax.min.js"></script>
<script type="text/javascript" src="<?= base_url('assets/'); ?>automotive/js/revolution.extension.slideanims.min.js"></script>
<script type="text/javascript" src="<?= base_url('assets/'); ?>automotive/js/revolution.extension.video.min.js"></script>

<!-- Twitter Feed Scripts 
     Uncomment to activate

<script type="text/javascript" src="<?= base_url('assets/'); ?>automotive/js/twitter/jquery.tweet.js"></script>
<script type="text/javascript" src="<?= base_url('assets/'); ?>automotive/js/twitter/twitter_feed.js"></script> -->
            ...
            <div id="rev_slider" class="rev_slider"  data-version="5.0">
                <ul>    
                    ...
                    <li data-transition="fade">
                        ...
                        <!-- MAIN IMAGE -->
                        <img src="<?= base_url('assets/'); ?>/automotive/images/slide-show1.jpg" alt="">                           
                    ...
                    <li data-transition="fade">
                        ...
                        <!-- MAIN IMAGE -->
                        <img src="<?= base_url('assets/'); ?>/automotive/images/slide-show2.jpg"  alt="">                           
                        ...
                        data-splitin="none" 
                        data-splitout="none" 
                        style="z-index: 6"><img src="<?= base_url('assets/'); ?>/automotive/images/brown_line.jpg" alt="underline"> </div>                    
                    </li>
                    ...
                    <li data-transition="fade">
                        ...
                        <!-- MAIN IMAGE -->
                        <img src="<?= base_url('assets/'); ?>/automotive/images/slide-show3.jpg" alt="">                           
                    ...
                    <li data-transition="fade">
                        <!-- MAIN IMAGE --> 
                        <img src="<?= base_url('assets/'); ?>/automotive/images/slide-show4.jpg" alt=""> 
                    ...
                    <li data-transition="fade"> 
                        <!-- MAIN IMAGE --> 
                        <img src="<?= base_url('assets/'); ?>/automotive/images/slide-show5.jpg" alt=""> 
    ...
    <div class="container">
        <div class="inner-page homepage margin-bottom-none">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 margin-bottom-none">
                            <div class="flip margin-bottom-30">
                                <div class="card">
                                    <div class="face front"><img class="img-responsive" src="<?= base_url('assets/'); ?>/automotive/images/car1.jpg" alt=""></div>
                                    <div class="face back">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 margin-bottom-none">
                            <div class="flip horizontal margin-bottom-30">
                                <div class="card">
                                    <div class="face front"><img class="img-responsive" src="<?= base_url('assets/'); ?>/automotive/images/car2.jpg" alt=""></div>
                                    <div class="face back">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 margin-bottom-none">
                            <div class="flip margin-bottom-30">
                                <div class="card">
                                    <div class="face front"><img class="img-responsive" src="<?= base_url('assets/'); ?>/automotive/images/car3.jpg" alt=""></div>
                                    <div class="face back">
            ...
            <div class="row parallax_parent design_2 margin-bottom-40 margin-top-30">
                <div class="parallax_scroll clearfix" data-velocity="-.5" data-offset="-200" data-image="<?= base_url('assets/'); ?>automotive/images/parallax1.jpg">
                    <div class="overlay">
                        <div class="container">
                            <div class="row">
                        ...
                        <div class="col-md-10 col-sm-8 padding-right-none xs-padding-left-none">
                            <div class="carasouel-slider3">
                                <div class="slide">
                                    ...
                                    <div class="car-block">
                                        <div class="img-flex"> <a href="inventory-listing.html"><span class="align-center"><i class="fa fa-3x fa-plus-square-o"></i></span></a> <img src="<?= base_url('assets/'); ?>/automotive/images/c-car1.jpg" alt="" class="img-responsive"> </div>
                                ...
                                <div class="slide">
                                    ...
                                    <div class="car-block">
                                        <div class="img-flex"> <a href="inventory-listing.html"><span class="align-center"><i class="fa fa-3x fa-plus-square-o"></i></span></a> <img src="<?= base_url('assets/'); ?>/automotive/images/c-car2.jpg" alt="" class="img-responsive"> </div>
                                        <div class="car-block-bottom">
                                ...
                                <div class="slide">
                                    <div class="car-block">
                                        <div class="img-flex"> <a href="inventory-listing.html"><span class="align-center"><i class="fa fa-3x fa-plus-square-o"></i></span></a> <img src="<?= base_url('assets/'); ?>/automotive/images/c-car3.jpg" alt="" class="img-responsive"> </div>
                                        <div class="car-block-bottom">
                                ...
                                <div class="slide">
                                    <div class="car-block">
                                        <div class="img-flex"> <a href="inventory-listing.html"><span class="align-center"><i class="fa fa-3x fa-plus-square-o"></i></span></a> <img src="<?= base_url('assets/'); ?>/automotive/images/c-car4.jpg" alt="" class="img-responsive"> </div>
                                        <div class="car-block-bottom">
                                ...
                                <div class="slide">
                                    <div class="car-block">
                                        <div class="img-flex"> <a href="inventory-listing.html"><span class="align-center"><i class="fa fa-3x fa-plus-square-o"></i></span></a> <img src="<?= base_url('assets/'); ?>/automotive/images/c-car5.jpg" alt="" class="img-responsive"> </div>
                                        <div class="car-block-bottom">
                                ...
                                <div class="slide">
                                    <div class="car-block">
                                        <div class="img-flex"> <a href="inventory-listing.html"><span class="align-center"><i class="fa fa-3x fa-plus-square-o"></i></span></a> <img src="<?= base_url('assets/'); ?>/automotive/images/c-car6.jpg" alt="" class="img-responsive"> </div>
                                        <div class="car-block-bottom">
                                ...
                                <div class="slide">
                                    <div class="car-block">
                                        <div class="img-flex"> <a href="inventory-listing.html"><span class="align-center"><i class="fa fa-3x fa-plus-square-o"></i></span></a> <img src="<?= base_url('assets/'); ?>/automotive/images/c-car7.jpg" alt="" class="img-responsive"> </div>
                                        <div class="car-block-bottom">
                                ...
                                <div class="slide">
                                    ...
                                    <div class="car-block">
                                        <div class="img-flex"> <a href="inventory-listing.html"><span class="align-center"><i class="fa fa-3x fa-plus-square-o"></i></span></a> <img src="<?= base_url('assets/'); ?>/automotive/images/c-car8.jpg" alt="" class="img-responsive"> </div>
                                        <div class="car-block-bottom">
                                ...
                                <div class="slide">
                                    <div class="car-block">
                                        <div class="img-flex"> <a href="inventory-listing.html"><span class="align-center"><i class="fa fa-3x fa-plus-square-o"></i></span></a> <img src="<?= base_url('assets/'); ?>/automotive/images/c-car9.jpg" alt="" class="img-responsive"> </div>
                                        <div class="car-block-bottom">
            ...
            <div class="row parallax_parent margin-top-30">
                <div class="parallax_scroll clearfix" data-velocity="-.5" data-offset="-300" data-no-repeat="true" data-image="<?= base_url('assets/'); ?>automotive/images/parallax2.jpg">
                    <div class="overlay">
                        <div class="container">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                ...
                <p>Copyright &copy; 2018 Theme Suite.  All rights reserved.</p>
            </div>
...
<div class="back_to_top"> <img src="<?= base_url('assets/'); ?>/automotive/images/arrow-up.png" alt="scroll up" /> </div>
<!-- Bootstrap core JavaScript --> 
<script src="<?= base_url('assets/'); ?>automotive/js/retina.js"></script> 
<script type="text/javascript" src="<?= base_url('assets/'); ?>automotive/js/jquery.parallax.js"></script> 
<script type="text/javascript" src="<?= base_url('assets/'); ?>automotive/js/jquery.inview.min.js"></script> 
<script src="<?= base_url('assets/'); ?>automotive/js/main.js"></script> 
<script type="text/javascript" src="<?= base_url('assets/'); ?>automotive/js/jquery.fancybox.js"></script> 
<script src="<?= base_url('assets/'); ?>automotive/js/modernizr.custom.js"></script> 
<script defer src="<?= base_url('assets/'); ?>automotive/js/jquery.flexslider.js"></script> 
<script src="<?= base_url('assets/'); ?>automotive/js/jquery.bxslider.js" type="text/javascript"></script> 
<script src="<?= base_url('assets/'); ?>automotive/js/jquery.selectbox-0.2.js" type="text/javascript"></script> 
<script type="text/javascript" src="<?= base_url('assets/'); ?>automotive/js/jquery.mousewheel.js"></script> 
<script type="text/javascript" src="<?= base_url('assets/'); ?>automotive/js/jquery.easing.js"></script>
</body>
</html>